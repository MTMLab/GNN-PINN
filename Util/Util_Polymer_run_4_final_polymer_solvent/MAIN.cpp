...
int main() {
  ...
  char command5[4500];
    ...
    DP del_xxx, del_yyy, del_zzz, EE, HH, Pi, HE, PIA, PIB;
  ...
  for (size_t i = 0; i < names.size(); i++) {
      ...
      outputFile10077 << "cp back/* lammps/" << names[i].c_str() << endl;
      ...
      outputFile10077 << "../Util/Util_monomer_modify_4_polymer_end_H_make/exe" << endl;
      ...
      outputFile10077 << "cp system.data ../lammps/" << names[i].c_str() << "/system.data" << endl;      
      outputFile10077 << "cd .." << endl;


      outputFile10077 << "cd moltemplates" << endl;
      outputFile10077 << "cp system.data ../ratio_calculation/polymer/system.data" << endl;
      outputFile10077 << "cd ../ratio_calculation/polymer" << endl;
      outputFile10077 << "../../../Util/lammps-2Aug2023/src/lmp_serial -i run_polymer_mass.npt2" << endl;
      outputFile10077 << "python polymer_mass.py" << endl;
      outputFile10077 << "cp extracted_mass.txt ../extracted_mass.txt" << endl;
      outputFile10077 << "cd ../.." << endl;
      
      outputFile10077 << "cp solvent/solvent.smi solvent.smi" << endl;
      outputFile10077 << "taskset --cpu-list 0 obabel -ismi solvent.smi -omol2 --gen3d --partialcharge eem -O solvent_com1.mol2" << endl;
      outputFile10077 << "antechamber -i solvent_com1.mol2 -fi mol2 -fo mol2 -o solvent_com2.mol2 -pf y -at gaff" << endl;
      outputFile10077 << "cp solvent_com2.mol2 mol2tolt_solvent/test/solvent.mol2" << endl;
      outputFile10077 << "cd mol2tolt_solvent/" << endl;
      outputFile10077 << "./run.sh" << endl;
      outputFile10077 << "cp test/solvent.lt ../moltemplates_solvent_single/solvent.lt" << endl;
      outputFile10077 << "cd .." << endl;
      
      outputFile10077 << "cd moltemplates_solvent_single" << endl;
      outputFile10077 << "../../Util/moltemplate-master/moltemplate/scripts/moltemplate.sh system.lt > moltemplate.log 2>&1" << endl;
      outputFile10077 << "cp system.data ../ratio_calculation/solvent/system.data" << endl;
      outputFile10077 << "cd ../ratio_calculation/solvent" << endl;
      outputFile10077 << "../../../Util/lammps-2Aug2023/src/lmp_serial -in run_solvent_mass.npt2" << endl;
      outputFile10077 << "python solvent_mass.py" << endl;
      outputFile10077 << "cp extracted_solvent_mass.txt ../extracted_solvent_mass.txt" << endl;
      outputFile10077 << "cd .." << endl;
      
      outputFile10077 << "python number_solvnet.py" << endl;
      outputFile10077 << "python factoring.py" << endl;
      outputFile10077 << "python solvent_lt.py" << endl;
      outputFile10077 << "cp system_solvent.lt ../system_solvent.lt" << endl;
      outputFile10077 << "cd .." << endl;
      ...
      outputFile10077 << "cp system_solvent.lt moltemplates_solvent/system.lt" << endl;
      outputFile10077 << "cd mol2tolt_solvent/" << endl;
      outputFile10077 << "./run.sh" << endl;
      
      outputFile10077 << "cp test/solvent.lt ../moltemplates_solvent/solvent.lt" << endl;
      outputFile10077 << "cd .." << endl;      
      
      outputFile10077 << "cd moltemplates_solvent" << endl;
      outputFile10077 << "../../Util/moltemplate-master/moltemplate/scripts/moltemplate.sh system.lt > moltemplate.log 2>&1" << endl;
      outputFile10077 << "cp system.data ../lammps/" << names[i].c_str() << "/system_solvent.data" << endl;
      outputFile10077 << "cd .." << endl;       

      outputFile10077 << "cd lammps/" << names[i].c_str() << endl;
      outputFile10077 << "python ../../group_polymer.py" << endl;
      outputFile10077 << "python ../../group_solvent.py" << endl;


      outputFile10077 << "../../../Util/lammps-2Aug2023/src/lmp_serial -in run_iso.in.npt2_wo_strain" << endl;
      outputFile10077 << "../../../Util/lammps-2Aug2023/src/lmp_serial -i run_iso.in.npt2_wo_strain_pppm" << endl;

      outputFile10077 << "../../../Util/Util_Polymer_Solvent_Output/exe" << endl;
    ...
    int systemRet1090 =  system(command1);
      ...
      inputFile309 >> EE >> HH >> Pi >> PIA >> PIB ;
      
      outfile << names[i].c_str() <<  "    "  << EE << "    " << HH << "    " << Pi << "    " << PIA << "    " << PIB << endl;
