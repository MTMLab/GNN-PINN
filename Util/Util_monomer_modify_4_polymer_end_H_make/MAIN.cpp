...
outputFile40 << "monomers[0] = new H_head" << endl;
d0 = 11;
outputFile40 << "monomers[1] = new cation.move(" << d0 << ",0,0)" << endl;  // cation
d0 = d0 + 11;
outputFile40 << "monomers[2] = new PPTA.move(" << d0 << ",0,0)" << endl;  // PPTA
d0 = d0 + interval;
outputFile40 << "monomers[3] = new PPTA.move(" << d0 << ",0,0)" << endl;  // PPTA
d0 = d0 + interval;
outputFile40 << "monomers[4] = new cation.move(" << d0 << ",0,0)" << endl;  // cation
d0 = d0 + 11;
outputFile40 << "monomers[5] = new PPTA.move(" << d0 << ",0,0)" << endl;  // PPTA
d0 = d0 + interval;
outputFile40 << "monomers[6] = new cation.move(" << d0 << ",0,0)" << endl;  // cation
d0 = d0 + 11;
outputFile40 << "monomers[7] = new PPTA.move(" << d0 << ",0,0)" << endl;  // PPTA
d0 = d0 + interval;
outputFile40 << "monomers[8] = new PPTA.move(" << d0 << ",0,0)" << endl;  // PPTA
d0 = d0 + interval;
outputFile40 << "monomers[9] = new cation.move(" << d0 << ",0,0)" << endl;  // cation
d0 = d0 + 11;
outputFile40 << "monomers[10] = new cation.move(" << d0 << ",0,0)" << endl;  // cation
d0 = d0 + 11;
outputFile40 << "monomers[11] = new H_tail.move(" << d0 << ",0,0)" << endl;
d0 = d0 + interval;
// Polymer chain generation code end

// Bond structure definition start
outputFile40 << "   write('Data Bond List') {" << endl;
outputFile40 << "    $bond:b1  $atom:monomers[0]/H_head $atom:monomers[1]/atom1" << endl;
...
outputFile40 << "    $bond:b10  $atom:monomers[9]/atom2 $atom:monomers[10]/atom1" << endl;
outputFile40 << "    $bond:b11  $atom:monomers[10]/atom2 $atom:monomers[11]/H_tail" << endl;
// Bond structure definition end
    ...
    outputFile401 << "0.0    " << d0+2 << "  xlo xhi" << endl;
