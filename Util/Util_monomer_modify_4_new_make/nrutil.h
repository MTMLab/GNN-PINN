...
class NRVec {
 ...
 public:
  NRVec();
  explicit NRVec(int n); // Zero-basedd array
...
// The next 3 classes are used in artihmetic coding, Huffmann coding, and 
// wavelet transforms respectively. This is as good a plage as any to put them!
